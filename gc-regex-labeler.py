...
if __name__ == "__main__":
    ...
    if args.export_csv:
        ...
        if config['global']['email_report']:
            ...
            body = f"""<html><head></head><body><h1>Assets Missing Key Labels Report</h1><p>This report was automatically generated by the Guardicore Regex Labeling Tool.<br><br><b>IMPORTANT</b>: Assets missing these labels may not get proper policy and may be at an elevated exposure level or may be incorrectly blocking traffic.<br><br>The report contains assets missing one of the following labels: <ul>"""
            for key in args.csv_label_keys:
                body += f"<li>{key}</li>"
